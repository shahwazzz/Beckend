...
const registerUser = asyncHandler(async (req, res) => {
  ...
  if (!createdUser) {
    throw new ApiError(500, "Something went wrong while regiestering the user");
  }
...
const loginUser = asyncHandler(async (req, res) => {
  ...
  // find the user
  // match the password if it is correct or not
  // if everthing goes right then generate access token or referesh token
  // return the response and send cookie
